...
map_suitability_fun <- function(suitable_raster) {
  ...
  suitable_raster_map <- ggplot() +
    ...
    theme_minimal() +
    coord_sf(datum = NA) +
    labs(x = "", y = "", title = "Suitable Land for Solar Energy Generation in CA") +
    annotation_scale(location = "bl", style = "ticks") # scale bar
  ...
  suitable_pct_map <- ggplot() +
    ...
    theme_minimal() +
    coord_sf(datum = NA) +
    labs(x = "", y = "", title = "Suitable Land by County in CA") +
    annotation_scale(location = "bl", style = "ticks") # scale bar
  ...
  return(list(suitable_raster_map, suitable_pct_map, counties_rank_df))
...
county_maps_2020 <- map_suitability_fun(suitable_raster = suitable_2020)
county_maps_2020
```
...
# Test mapping by county function
county_maps_2050 <- map_suitability_fun(suitable_raster = suitable_2050)
county_maps_2050
```
